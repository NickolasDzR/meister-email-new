...
export const headContacts: HeadContactsType[] = [
    ...
    {
        "href": "mailto:nickolasdzr@yandex.ru?subject=Давайте сотрудничать!",
        "style": {...link},
...
export const reviews: ReviewsType = {
    ...
    "data": [
        "Отличный перевозчик, профессионал своего дела. Быстрый, четкий контроль погрузочно-разгрузочных работ. Информативность и добросовестность. Успехов вам и процветания! Рекомендую!",
        "Замечательный, ответственный перевозчик! Оперативность, качество, приятное общение, порядочность — все это вызывает уважение! Спасибо за профессиональный подход к делу. Желаем процветания и успехов!",
        "Рекомендую к сотрудничеству, оплата в срок, всегда на связи, все вопросы решаются сразу, приятно работать с людьми, которые ответственно подходят к своей работе."
    ],
    "link": {
